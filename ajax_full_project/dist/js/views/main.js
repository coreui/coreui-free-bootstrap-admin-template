$(function(){
  ...
  var data = {
    ...
    datasets: [
      {
        label: 'My First dataset',
        backgroundColor: style.getPropertyValue('--info'),
        borderColor: 'rgba(255,255,255,.55)',
  ...
  var data = {
    ...
    datasets: [
      {
        label: 'My First dataset',
        backgroundColor: convertHex(style.getPropertyValue('--info'),10),
      ...
      },
      {
        ...
        borderColor: style.getPropertyValue('--success'),
        pointHoverBackgroundColor: '#fff',
        borderWidth: 2,
        data: data2
      },
  ...
  var data3 = {
    ...
    datasets: [
      {
        backgroundColor: 'transparent',
        borderColor: style.getPropertyValue('--warning'),
        borderWidth: 2,
        data: [35, 23, 56, 22, 97, 23, 64]
      }
    ]
