      ...
      <div class="body flex-grow-1">
        <div class="container-lg px-4">
          ...
          <div class="card mb-4">
            ...
            <div class="card-body">
              <p class="text-body-secondary small">Building on the above example, you can create different toast color schemes with our <a href="https://coreui.io/docs/utilities/colors/">color</a> and <a href="https://coreui.io/docs/utilities/background/">background</a> utilities. Here we’ve added <code>.bg-primary</code> and <code>.text-white</code> to the <code>.toast</code>, and then added <code>.btn-close-white</code> to our close button. For a crisp edge, we remove the default border with <code>.border-0</code>.</p>
              <div class="example">
                <ul class="nav nav-underline-border" role="tablist">
