          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="card mb-4">
                ...
                <div class="card-body">
                  <p class="text-body-secondary small">Change the horizontal alignment of your nav with <a href="https://coreui.io/docs/layout/grid/#horizontal-alignment">flexbox utilities</a>. By default, navs are left-aligned, but you can easily change them to center or right aligned.</p>
