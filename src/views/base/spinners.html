...
<html lang="en">
  <head>
    ...
    <link rel="canonical" href="https://coreui.io/docs/components/spinners/">
  </head>
  <body>
          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="card mb-4">
                ...
                <div class="card-body">
                  <p class="text-body-secondary small">The border spinner uses <code>currentColor</code> for its <code>border-color</code>, meaning you can customize the color with <a href="https://coreui.io/docs/utilities/colors/">text color utilities</a>. You can use any of our text color utilities on the standard spinner.</p>
                  <div class="example">
                    <ul class="nav nav-underline-border" role="tablist">
            ...
            <div class="col-12">
              <div class="card mb-4">
                ...
                <div class="card-body">
                  ...
                  <p class="text-body-secondary small">Once again, this spinner is built with <code>currentColor</code>, so you can easily change its appearance with <a href="https://coreui.io/docs/utilities/colors/">text color utilities</a>. Here it is in blue, along with the supported variants.</p>
                  <div class="example">
                    <ul class="nav nav-underline-border" role="tablist">
            ...
            <div class="col-12">
              <div class="card mb-4">
                ...
                <div class="card-body">
                  <p class="text-body-secondary small">Use <a href="https://coreui.io/docs/utilities/spacing/">margin utilities</a> like <code>.m-5</code> for easy spacing.</p>
                  <div class="example">
                    <ul class="nav nav-underline-border" role="tablist">
