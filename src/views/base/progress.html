            ...
            <div class="col-12">
              <div class="card mb-4">
                ...
                <div class="card-body">
                  ...
                  <p class="text-body-secondary small">Bootstrap provides a handful of <a href="https://coreui.io/docs/utilities/sizing/">utilities for setting width</a>. Depending on your needs, these may help with quickly configuring progress.</p>
                  <div class="example">
                    <ul class="nav nav-underline-border" role="tablist">
