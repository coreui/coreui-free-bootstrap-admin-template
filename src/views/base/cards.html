      ...
      <div class="body flex-grow-1">
        <div class="container-lg px-4">
          <div class="card mb-4">
            ...
            <div class="card-body">
              <p class="text-body-secondary small">Cards are built with as little markup and styles as possible but still manage to deliver a bunch of control and customization. Built with flexbox, they offer easy alignment and mix well with other Bootstrap components. Cards have no top, left, and right margins by default, so use <a href="https://coreui.io/docs/utilities/spacing/">spacing utilities</a> as needed. They have no fixed width to start, so they’ll fill the full width of its parent.</p>
          ...
          <div class="card mb-4">
            ...
            <div class="card-body">
              <p class="text-body-secondary small">Use some of <a href="https://coreui.io/docs/utilities/sizing/">available sizing utilities</a> to rapidly set a card’s width.</p>
              <div class="example">
                <ul class="nav nav-underline-border" role="tablist">
          ...
          <div class="card mb-4">
            ...
            <div class="card-body">
              <p class="text-body-secondary small">You can instantly change the text arrangement of any card—in its whole or specific parts—with <a href="https://coreui.io/docs/utilities/text/#text-alignment">text align classes</a>.</p>
              <div class="example">
                <ul class="nav nav-underline-border" role="tablist">
          ...
          <div class="card mb-4">
            ...
            <div class="card-body">
              <p class="text-body-secondary small">Add some navigation to a card’s header (or block) with Bootstrap’s <a href="https://coreui.io/docs/components/navs-tabs/">nav components</a>.</p>
              <div class="example">
                <ul class="nav nav-underline-border" role="tablist">
          ...
          <div class="card mb-4">
            ...
            <div class="card-body">
              <p class="text-body-secondary small">Use <a href="https://coreui.io/docs/utilities/borders/">border utilities</a> to change just the <code>border-color</code> of a card. Note that you can put <code>.text-{color}</code> classes on the parent <code>.card</code> or a subset of the card’s contents as shown below.</p>
              <div class="example">
                <ul class="nav nav-underline-border" role="tablist">
          ...
          <div class="card mb-4">
            ...
            <div class="card-body">
              <p class="text-body-secondary small">Use <a href="https://coreui.io/docs/utilities/borders/">border utilities</a> to change just the <code>border-top-color</code> of a card. Note that you can put <code>.text-{color}</code> classes on the parent <code>.card</code> or a subset of the card’s contents as shown below.</p>
              <div class="example">
                <ul class="nav nav-underline-border" role="tablist">
