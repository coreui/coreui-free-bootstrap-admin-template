              ...
              <div class="card">
                <div class="card-header">
                  ...
                  <div class="card-actions">
                    ...
                    <button class="btn btn-minimize" type="button" data-toggle="collapse" data-target="#collapseExample1" aria-expanded="true" aria-controls="collapseExample1">
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  ...
                  <div class="card-actions">
                    <a href="#" class="btn-setting"><i class="icon-settings"></i></a>
                    <button class="btn-minimize" type="button" data-toggle="collapse" data-target="#collapseExample2" aria-expanded="true" aria-controls="collapseExample2">
                      <i class="icon-arrow-up"></i>
                    </button>
                    <a href="#" class="btn-close"><i class="icon-close"></i></a>
                  </div>
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  ...
                  <div class="card-actions">
                    <a href="#" class="btn-setting"><i class="icon-settings"></i></a>
                    <button class="btn-minimize" type="button" data-toggle="collapse" data-target="#collapseExample3" aria-expanded="true" aria-controls="collapseExample3">
                      <i class="icon-arrow-up"></i>
                    </button>
                    <a href="#" class="btn-close"><i class="icon-close"></i></a>
                  </div>
