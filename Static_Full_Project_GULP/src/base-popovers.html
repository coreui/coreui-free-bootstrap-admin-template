...
<body class="app header-fixed sidebar-fixed aside-menu-fixed aside-menu-hidden">
          ...
          <div class="card">
            <div class="card-header">
              ...
              <div class="card-actions">
                <a href="http://coreui.io/docs/components/bootstrap-popover/popovers.html" target="_blank">
            ...
            <div class="card-body">
              ...
              <hr>
              <a tabindex="0" class="btn btn-lg btn-danger" role="button" data-toggle="popover" data-trigger="focus" title="Dismissible popover" data-content="And here's some amazing content. It's very engaging. Right?">Dismissible
        popover</a>
            </div>
          </div>
          <div class="card">
  ...
  <script src="js/views/popovers.js"></script>
