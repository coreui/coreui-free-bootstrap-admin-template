        ...
        <div class="animated fadeIn">
          <div class="card">
            <div class="card-header">
              <i class="fa fa-align-justify"></i> Navbar
              <div class="card-actions">
                <a href="http://coreui.io/docs/components/bootstrap-navbar/" target="_blank">
          ...
          <div class="card">
            <div class="card-header">
              <i class="fa fa-align-justify"></i> Navbar brand
            </div>
            <div class="card-body">
              <!-- As a link -->
              ...
              <nav class="navbar navbar-light bg-light">
                <a class="navbar-brand" href="#">
                  <img src="/img/logo-symbol.png" width="30" height="30" alt="">
                </a>
              </nav>
              <hr>
              <!-- Image and text -->
              <nav class="navbar navbar-light bg-light">
                <a class="navbar-brand" href="#">
                  <img src="/img/logo-symbol.png" width="30" height="30" class="d-inline-block align-top" alt=""> Bootstrap
                </a>
              </nav>
            </div>
          </div>
