      ...
      <div class="body flex-grow-1 px-3">
        <div class="container-lg">
          <div class="card mb-3">
            ...
            <div class="card-body">
              <p>CoreUI Free Bootstrap Admin Template is built on top of <a href="https://coreui.io/bootstrap/ui-components/">CoreUI UI Components Library</a>, so if you're looking for documentation for a specific component please check this <a href="https://coreui.io/docs/components/">documentation.</a></p>
              <h2>Installation</h2>
              ...
              <p>CoreUI Admin Template uses <a href="https://docs.npmjs.com/misc/scripts/">npm scripts</a> for its build system. Our <a href="https://github.com/coreui/coreui-free-bootstrap-admin-template/blob/v4.1.1/package.json">package.json</a> includes convenient methods for working with the framework, including compiling code, running tests, and more.</p>
              ...
              <ol>
                ...
                <li>Either <a href="https://github.com/coreui/coreui-free-bootstrap-admin-template/archive/v4.1.1.zip">download CoreUI’s sources</a> or fork <a href="https://github.com/coreui/coreui-free-bootstrap-admin-template">CoreUI’s repository</a>.</li>
                <li>Navigate to the root <code>/coreui-free-bootstrap-admin-template</code> directory and run <code>npm install</code> to install our local dependencies listed in <a href="https://github.com/coreui/coreui-free-bootstrap-admin-template/blob/v4.1.1/package.json">package.json</a>.</li>
              </ol>
              ...
              <p>Our <a href="https://github.com/coreui/coreui-free-bootstrap-admin-template/blob/v4.1.1/package.json">package.json</a> includes numerous tasks for developing the project. Run <code>npm run</code> to see all the npm scripts in your terminal. <strong>Primary tasks include:</strong></p>
              <table class="table">
                <thead>
                  <tr>
                    <th>Task</th>
